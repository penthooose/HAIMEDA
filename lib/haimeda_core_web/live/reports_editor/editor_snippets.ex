defmodule HaimedaCoreWeb.ReportsEditor.EditorSnippets do
      ...
      <div class="p-4 flex-grow bg-white text-black">
        ...
        <div class="mb-4">
          <div class="flex justify-between items-center mb-2">
            ...
            <div class="flex items-center gap-2">
              <!-- Modern circular spinner moved further left -->
              <div class={if @loading, do: "flex items-center mr-2", else: "hidden"}>
                <div class="w-4 h-4 border-2 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
              </div>

              <!-- Buttons with order switched -->
              <!-- Auto chapter creation button (now first) -->
              <button
                type="button"
              ...
              <!-- Manual verification button (now second) -->
              <button
                type="button"
              ...
              <!-- New AI text optimization button -->
              <button
                type="button"
  ...
  def parties_tab_content(assigns) do
    ...
    # Fix: use assign with separate statements for each assignment
      ...
      <div class="p-4 flex-grow bg-white text-black">
        ...
        <div class="mb-6">
          <div class="flex items-center justify-between mb-2">
            ...
            <!-- Changed to use phx-click instead of phx-submit form -->
            <button
              type="button"
  ...
  # Keep parse_statements for backward compatibility

defmodule HaimedaCoreWeb.ReportsEditor.TiptapActions do
  ...
  # Import functions from Phoenix.LiveView and Phoenix.Component
  ...
  # defp mark_entity_in_node(node, entity_id, is_deleted) do
  #   if is_map(node) and Map.has_key?(node, "content") and is_list(node["content"]) do
  #     Map.put(
  #       node,
  #       "content",
  #       Enum.map(node["content"], fn child ->
  #         mark_entity_in_node(child, entity_id, is_deleted)
  #       end)
  #     )
  #   else

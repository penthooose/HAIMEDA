defmodule HaimedaCore.EditorSession do
  ...
  # Change default to internal value
  @default_verification_degree :moderate_match

  # Add mapping for verification degrees to internal values
  ...
  defp ensure_required_fields(session_data) do
    ...
    # Add new field with default false
  ...
  def prepare_session_data(socket) do
    ...
    # Use previous_content_mode instead of use_summaries
    ...
    internal_verification_degree =
      cond do
        # Already an atom like :moderate_match - use it directly
        is_atom(verification_degree) ->
          verification_degree

        # Display string like "Mittlere Übereinstimmung" - convert to atom
    ...
    # Get llm_initialized flag from socket assigns or default to current value in DB

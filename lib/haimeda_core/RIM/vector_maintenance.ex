defmodule RIM.VectorMaintenance do
  ...
  # Updated to use separate vectors collection but keep file_tracking in RAG
  @rag_collection "RAG"
  ...
  Now also validates vector existence for each tracked file.
        ...
        {:ok, content} ->
          ...
          if token_count < 20 do
            ...
            if use_file_per_chunk && String.contains?(file_path, "single_chapters") do
              ...
              # Use the new nested structure with chapter metadata when appropriate

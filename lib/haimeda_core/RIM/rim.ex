...
# search_map_single_chapter_vectors = %{
#   "chapter_type" => "regular_chapter",
#   "subcollection" => "single_chapter_vectors"
# }

# search_map_report_vectors = %{
#   "subcollection" => "report_vectors"
# }

# full_report_vectors_search_results =
#   VectorPersistence.extract_similar_vectors_data(
#     search_map_single_chapter_vectors,
#     embedded_user_request
#   )

# IO.inspect(full_report_vectors_search_results, label: "Full Vectors Search Results")

defmodule RIM.VectorPersistence do
  ...
  def verify_existence_of_vectors(rag_config) do
    ...
    IO.inspect(Process.get(:chunking_subcollections, []), label: "chunking subcollections")
  ...
  defp read_docx_file(file_path) do
    # This is a placeholder - you'll need to implement a way to extract text from docx files

defmodule PostProcessing.SymbolicEntityConstructor do
  ...
  def detect_all_patterns(data) do
    ...
    # IO.inspect(identifier_patterns, label: "Identifier Patterns")
    ...
    # IO.inspect(all_patterns, label: "All Patterns")
  ...
  def extract_patterns(data, type) do
    case type do
      ...
      :identifier ->
        result = HF.extract_identifier_patterns(data)
        IO.inspect(result, label: "Identifier Patterns")
        result

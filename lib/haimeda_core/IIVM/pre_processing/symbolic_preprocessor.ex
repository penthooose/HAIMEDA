defmodule PreProcessing.SymbolicPreProcessor do
  ...
  # Update the path to use either:
  # 1. Application-based path resolution
  ...
  def verify_LLM_input(data, chapter_type) do
    ...
    case chapter_data do
      ...
      chapter_data ->
        # Access conditions from the correct path
        conditions = chapter_data["conditions"]
        # Fix: Access core_conditions through the conditions map

defmodule LLMService do
  ...
  def verify_model_existence(model) do
    ...
    # case OllamaService.list_available_models() do
    #   [] -> IO.puts("No models found or error listing models")
    #   models -> Enum.each(models, fn m -> IO.puts("- #{m}") end)
    # end
    ...
    case OllamaService.pull_model_if_not_available(model) do
      ...
      {:error, :model_not_available} ->
        ...
        # Find the most similar model from available models
        most_similar =

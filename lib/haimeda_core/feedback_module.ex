defmodule HaimedaCore.FeedbackModule do
  ...
  Valid sender types:
  - "system" - For system messages and welcome messages
  - "user" - For user-entered messages
  - "symbolic_ai" - For messages from symbolic AI components (IIV)
  - "sub-symbolic_ai" - For messages from sub-symbolic AI (LLM)
  - "hybrid_ai" - For messages from hybrid AI approaches (combining symbolic and sub-symbolic)
  """

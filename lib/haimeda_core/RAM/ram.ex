defmodule RAM do
  ...
  # Function that wraps LLMService.query with retry logic
  ...
  def sanitize_response(response) do
    # Remove "Kapitel" line if present at the beginning
    lines = String.split(response, "\n")

    filtered_lines =
      lines
      |> Enum.reject(fn line ->
        # Remove the first line if it starts with "Kapitel"
        # Match lines with brackets at the beginning or end of the text
        # Also reject lines containing specific keywords
  ...
  # Helper function to unescape common escaped symbols in the response
